...
from diffusion_policy.policy.diffusion_transformer_hybrid_image_policy_paths import (
    DiffusionTransformerHybridImagePolicyPaths,
)
...
class TrainDiffusionTransformerHybridWorkspacePaths(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: DiffusionTransformerHybridImagePolicyPaths = (
            hydra.utils.instantiate(cfg.policy)
        )

        self.ema_model: DiffusionTransformerHybridImagePolicyPaths = None
